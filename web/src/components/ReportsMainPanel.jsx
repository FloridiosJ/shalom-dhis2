    ...
    >
      {evolutionLoading ? (
        ...
        <div className={styles.noData}>
          ...
          <h4 className={styles.noDataTitle}>Aucune donnée disponible</h4>
          <p className={styles.noDataText}>Il n'y a pas de consultations pour cette période</p>
          <p className={styles.noDataHint}>Essayez de modifier les filtres ou sélectionner une autre période</p>
        </div>
      )}
    </ChartCard>
  );
    ...
    >
      {diagnosticsLoading ? (
        ...
        <div className={styles.noData}>
          ...
          <h4 className={styles.noDataTitle}>Aucun diagnostic enregistré</h4>
          <p className={styles.noDataText}>Aucun diagnostic n'a été enregistré pour cette période</p>
          <p className={styles.noDataHint}>Les diagnostics apparaîtront ici une fois les consultations saisies</p>
        </div>
      )}
    </ChartCard>
  );
    ...
    >
      {medicationsLoading ? (
        ...
        <div className={styles.noData}>
          ...
          <h4 className={styles.noDataTitle}>Aucun médicament prescrit</h4>
          <p className={styles.noDataText}>Aucun médicament n'a été prescrit pour cette période</p>
          <p className={styles.noDataHint}>Les prescriptions apparaîtront ici une fois les consultations complétées</p>
        </div>
      )}
    </ChartCard>
  );
